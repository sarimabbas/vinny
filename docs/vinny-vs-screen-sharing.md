...
Apple's Screen Sharing viewer can connect to Vinny using **Legacy authentication (unencrypted)**. This does not encrypt screen contents or input. Use a secure tunnel. The [connection guide](first-connection.md) covers clients and secure connection options.
